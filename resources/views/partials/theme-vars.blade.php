...
<style>
    :root {
        ...
        --brand-wine-rgb: {{ sscanf($coresTema[2], '#%02x%02x%02x')[0] }}, {{ sscanf($coresTema[2], '#%02x%02x%02x')[1] }}, {{ sscanf($coresTema[2], '#%02x%02x%02x')[2] }};
        --brand-red-strong: {{ $coresTema[3] }};
        --brand-red-strong-rgb: {{ sscanf($coresTema[3], '#%02x%02x%02x')[0] }}, {{ sscanf($coresTema[3], '#%02x%02x%02x')[1] }}, {{ sscanf($coresTema[3], '#%02x%02x%02x')[2] }};
        --brand-surface: {{ $coresTema[4] }};
        --brand-charcoal: {{ $coresTema[5] }};
        --brand-charcoal-rgb: {{ sscanf($coresTema[5], '#%02x%02x%02x')[0] }}, {{ sscanf($coresTema[5], '#%02x%02x%02x')[1] }}, {{ sscanf($coresTema[5], '#%02x%02x%02x')[2] }};
